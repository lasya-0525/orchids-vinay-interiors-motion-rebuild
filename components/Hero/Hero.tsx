...
const headline = ["Spaces", "That", "Breathe"];
    ...
    >
      ...
      >
        <Image
          ...
          alt="Vinay Interiors – Luxury Interior"
          fill
        ...
        >
          ...
          >
            ...
            <p style={{
              ...
              Hyderabad · Architecture &amp; Interiors
            </p>
          </motion.div>
          ...
          >
            <p style={{
              ...
              Bespoke interiors and architecture for Hyderabad&apos;s most discerning homes and workspaces. Precision. Materiality. Timeless form.
            </p>
      ...
      >
        <div style={{
          ...
          <p style={{ fontFamily: "var(--font-playfair,Georgia,serif)", fontSize: "2.5rem", color: "#ffffff", lineHeight: 1, fontWeight: 600 }}>2014</p>
        </div>
      </motion.div>
